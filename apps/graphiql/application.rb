...
module Graphiql
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['GRAPHIQL_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Graphiql::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Graphiql::Action is included
      ...
      # Configure the code that will yield each time Graphiql::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Graphiql::Assets::Helpers
      end
    end
